...
subsection \<open>Introducing new Boogie variables for the evaluatoin and well-definedness state\<close>
...
proof -
  ...
  obtain mb where LookupVarOldVar: "lookup_var (var_context ctxt) ns (mask_var Tr) = Some (AbsV (AMask mb))" and
